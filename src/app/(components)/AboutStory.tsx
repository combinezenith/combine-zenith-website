...
export default function AboutStory() {
  return (
    <section aria-label="" className="mt-20 relative py-20 overflow-hidden">
      {/* Background Elements */}
      <div aria-label="" className="absolute inset-0 overflow-hidden">
        <div aria-label="" className="absolute -top-32 -right-32 w-64 h-64 rounded-full blur-3xl" />
        <div aria-label="" className="absolute -bottom-32 -left-32 w-64 h-64 rounded-full blur-3xl" />
        <div aria-label="" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl" />
      </div>

      <div aria-label="" className="mb-20 container mx-auto px-6 relative z-10">
        <div aria-label="" className="max-w-4xl mx-auto">
          {/* Header Section */}
          ...
          {/* Content Section */}
<div aria-label="" className="space-y-8 text-center max-w-3xl mx-auto text-bold">
