  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="https://www.linkedin.com/company/combine-zenith/" aria-label="LinkedIn" className="text-white hover:text-purple-300 transition transform hover:scale-110 p-2 bg-white/10 backdrop-blur-sm rounded-full">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
