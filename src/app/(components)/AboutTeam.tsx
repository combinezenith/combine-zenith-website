  ...
  const teamMembers = [
    {
      ...
      description: "Visionary leader driving strategic direction and fostering meaningful client partnerships.",
      image: "/team/jane-doe.jpg" // Replace with actual image path
    },
    {
      name: "John Smith",
      position: "Head of Strategy",
      description: "Master strategist crafting impactful market plans that drive client success and growth.",
      image: "/team/john-smith.jpg" // Replace with actual image path
    },
    {
      name: "Emily White",
      position: "Lead Creative Director",
      description: "Award-winning creative mind transforming ideas into captivating brand experiences.",
      image: "/team/emily-white.jpg" // Replace with actual image path
    },
    {
      name: "David Chen",
      position: "Senior Marketing Analyst",
      description: "Data-driven expert uncovering market trends to optimize client performance and ROI.",
    ...
    <section aria-label="Meet The Team Section" className="relative py-20 overflow-hidden">
      ...
      <div aria-label="Team Container" className="container mx-auto px-6 relative z-10">
        <div aria-label="Team Content" className="max-w-6xl mx-auto">
          ...
          {/* Team Grid */}
          <div aria-label="Team Members Grid" className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div aria-label="Social Media Links" className="flex justify-center space-x-3 mt-6 pt-6 border-t border-gray-700/50">
                  ...
                  <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
